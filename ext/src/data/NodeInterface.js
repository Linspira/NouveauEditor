        ...
        getPrototypeBody: function() {
            ...
            return {
                ...
                createNode: function(node) {
                    ...
                    if (!node.isModel) {
                        // Honour this node type's childType configuration
                        if (me.childType) {
                            ModelClass = me.getProxy().reader.resolveModelClass(me.childType, me);
                        } else {
                            ModelClass = me.self;
                        }
                ...
                appendChild: function(node, suppressEvents, commit) {
                    ...
                    if (Ext.isArray(node)) {
                        ...
                        // Inform the TreeStore so that the node can be registered, filtered and joined.
                ...
                */
                ...
                sort: function(sortFn, recursive, suppressEvent) {
                    ...
                    if (ln > 0) {
                        if (!sortFn) {
                            sortFn = me.getOwnerTree().store.generateComparator();
                        }
                ...
                expandChildren: function(recursive, callback, scope, /* private */ singleExpand) {
                    var me = this,
                        origCallback, owner, i, allNodes, expandNodes, ln, node;
                    ...
                    if (singleExpand === undefined) {
                        owner = me.getOwnerTree();
                        singleExpand = owner && owner.singleExpand;
                    }
