...
Ext.define('Ext.data.TreeStore', {
    ...
    onNodeAdded: function(parent, node) {
        ...
        if (!node.isLeaf() && !node.isLoaded() && !me.lazyFill) {
            ...
            if (dataRoot) {
                me.fillNode(node, reader.extractData(dataRoot, node.childType));
            }
        }
